...
MAX_BIOMASS = 1250                          # Maximum biomass in grams
LIFETIME = 60                             # Maximum life time of the plant in days
...
K = 25      # Parameter to tune the growth curve  (peak day)
A = 10      # Parameter to tune the growth curve  (controls the spread)
